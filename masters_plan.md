...
|---|---|---|---|---|---|
| **Transfer** | Train on international attrition (Saudi+Russian) → predict SL intention | 4 shared | **0.64** (SMOTETOMEK, seed 42; seed-averaged 0.72 ± 0.10 — unstable. See P2 §12 #7) | 0.29 | None — recall 0.80 needs precision ~0.15 (flags ~90% of staff) |
